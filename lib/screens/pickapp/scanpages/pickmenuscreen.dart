...
class PickmenuScreen extends StatefulWidget {
  const PickmenuScreen({Key? key}) : super(key: key);
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () => Navigator.pushNamed(
                                  context, Routes.singleitemscanscreen),
                              child: Container(
                                  height: 150,
                                  width: 400,
                                  decoration: BoxDecoration(
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              // onPress: () {
                              //   Navigator.pushNamed(context, Routes.putawayscreen);
                              // },
                            ),
                            Sizer.halfHorizontal(),
                            InkWell(
                              onTap: () => Navigator.pushNamed(
                                  context, Routes.multiitemscanscreen),
                              child: Container(
                                  height: 150,
                                  width: 400,
                                  decoration: BoxDecoration(
