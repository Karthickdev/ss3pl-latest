...
class AlertDialogBodypickapp extends ConsumerWidget {
  final String logoutMessage;
  const AlertDialogBodypickapp({Key? key, required this.logoutMessage})
      : super(key: key);
...
class AlertDialogHeaderpickapp extends StatelessWidget {
  const AlertDialogHeaderpickapp({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context, ScopedReader watch) {
    ...
    return CustomTextButton(
        ...
        onPress: () {
          ...
          singleitemModel.eventLogController.text = "";
          multiitemModel.eventLogController.text = "";
          Navigator.pop(context);
          Navigator.pop(context);
        });
  }
