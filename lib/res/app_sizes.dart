...
class AppSizes {
  ...
  late double extrajumboFontSize;
  late double extraMidjumboFontSize;
  ...
  void initializeSize(BuildContext context) {
    ...
    extrajumboFontSize = 32.0 * fontRatio;
    extraMidjumboFontSize = 36.0 * fontRatio;
    ...
    semiextrapadding = 60.0 *widthRatio;
